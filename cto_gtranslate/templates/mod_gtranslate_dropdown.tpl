...
<noscript>Javascript is required to use this <a href="http://gtranslate.net/">website translator</a>, <a href="http://gtranslate.net/">online translator</a></noscript>
...
<div class="<?php echo $this->class; ?> block"<?php echo $this->cssID; ?><?php if ($this->style): ?> style="<?php echo $this->style; ?>"<?php endif; ?>>
    ...
    foreach($this->languages as $lang => $lang_name) {
        if($this->$lang) {
            ...
            echo '<option value="'.$this->mainlang.'|'.$lang.'" style="'.($lang == $this->mainlang ? 'font-weight:bold;' : '').'background:url(\'system/modules/gtranslate/html/16l.png\') no-repeat scroll 0 -'.($i*16).'px;padding-left:18px;">'.$lang_name.'</option>';
        }
        $i++;
    }
    ?>
